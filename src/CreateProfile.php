...
<table>
<select name="dept">
  <option value="School of Electrical & Computer Engineering">Electrical and Electronics Engineering</option>
  <option value="College of Computing">Computer Science and Engineering</option>
  <option value="School of Industrial & Systems Engineering">Information Technology</option>
</select>
</table>
